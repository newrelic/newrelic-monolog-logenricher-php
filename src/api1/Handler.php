...
class Handler extends AbstractHandler
{
    ...
    /**
     * Iterates over batched data, filtering out logs with levels
     * lower than the constructed threshold. If applicable logs are found,
     * they are formatted as a JSON array compatible with New Relic's batch
     * Log ingest and delegated to sendBatch()
     *
     * @param array $record
     */
    ...
    /**
     * Sets Handler's Formatter. Note: only NewRelic\Monolog\Enricher\Formatter
     * is compatible.
     *
